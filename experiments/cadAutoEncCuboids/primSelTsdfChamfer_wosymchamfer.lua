...
params.visDir = '../cachedir/visualization_chair_wosymchamfer/' .. params.name
params.visMeshesDir = '../cachedir/visualization_chair_wosymchamfer/meshes/' .. params.name
params.snapshotDir = '../cachedir/snapshots_chair_wosymchamfer/' .. params.name
...
if params.usePretrain then
    ...
    local netPretrain = torch.load(paths.concat('../cachedir/snapshots_chair', params.pretrainNet,'iter' .. tostring(params.pretrainIter) .. '.t7'))
